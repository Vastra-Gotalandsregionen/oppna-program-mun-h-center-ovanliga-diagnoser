function setLanguage(lang)
{
    ...
    if(language == 'swe')
    {
        ...
        $('.lang_blasor').html('Tips vid bl&aring;sor (afte) och s&aring;r');
        $('.lang_blasor_short').html('Bl&aring;sor');
        ...
        $('.lang_tandborstning_text28').html('Tandkr\u00E4m utan smak. Salutem barntandkr\u00E4m anv\u00E4nds f\u00F6r barn under 6 \u00E5r. F\u00F6r barn \u00F6ver 6 \u00E5r anv\u00E4nds Salutem vuxentandkr\u00E4m alternativt Proxident tandkr\u00E4m f\u00F6r torr och k\u00E4nslig mun');
        $('.lang_tandborstning_text29').html('Specialtandkr&auml;m f&ouml;r personer som st&aring;r p&aring; KETOGEN KOST. Rekommenderas p&aring; individuell indikation och tillhandah&aring;lls via tandv&aring;rden: Barn 0-3 &aring;r: Profylaxpasta CCS RDA 40, 0,1% fluor. Hanteras som vanlig tandkr&auml;m f&ouml;r &aring;ldersgruppen. Produkten inneh&aring;ller Sackarinnatrium &lt;1%. Alternativ: Borsta med Dentan fluorl&ouml;sning 0,05% NaF (utan smak). 5 ml l&ouml;sning sp&auml;des med 5ml vatten. Barn fr&aring;n 4 &aring;r: Profylaxpasta CCS RDA 40, 0,1% fluor. Hanteras som vanlig tandkr&auml;m f&ouml;r &aring;ldersgruppen. Produkten inneh&aring;ller Sackarinnatrium &lt;1%. Alternativ: Borsta med Dentan fluorl&ouml;sning 0,05% NaF (utan smak).');
        ...
        $('.lang_tandborstning_text31').html('Fluorl&ouml;sning 0,05 % NaF f&ouml;r barn 6-12 &aring;r och fluorl&ouml;sning 0,2 % NaF f&ouml;r barn &ouml;ver 12 &aring;r samt f&ouml;r vuxna. Anv&auml;nds vid behov av f&ouml;rst&auml;rkt f&ouml;rebyggande munv&aring;rd.');
        ...
        $('.lang_blasor_text1').html('Munv&aring;rd f&oumlr barn - (afte) och s&aring;r');
        $('.lang_blasor_text2').html('Bl&aring;sor och s&aring;r i munslemhinnan och p&aring; tungan kan orsaka sm&auml;rta och medf&ouml;ra sv&aring;righeter att &auml;ta, tala och utf&ouml;ra munv&aring;rd. Vid sv&aring;ra besv&auml;r rekommenderas att kontakta tandv&aring;rden.');
        $('.lang_blasor_text3').html('F&Ouml;RSLAG P&Aring; PRODUKTER SOM KAN LINDRA SM&Auml;RTA SAMT UNDERL&Auml;TTA L&Auml;KNING');
        $('.lang_blasor_text4').html('Zendiumtandkr&auml;m (Vuxen, Junior). Rekommenderas att anv&auml;nda kontinuerligt vid &aring;terkommande besv&auml;r');
        $('.lang_blasor_text5').html('Sinaftin tandkr&auml;m. Rekommenderas att anv&auml;nda kontinuerligt vid &aring;terkommande besv&auml;r');
        $('.lang_blasor_text6').html('Aftaclear sk&ouml;lj/gel/spray. Ger omedelbar och l&aring;ngvarig lindring');
        $('.lang_blasor_text7').html('Ytterligare information om munv&aring;rdsprodukter och hj&auml;lpmedel finns p&aring; f&ouml;ljande hemsidor: <br> <a href="http://www.mun-h-center.se">www.mun-h-center.se</a> <br>    <a href="http://www.apotea.se" target="_blank">www.apotea.se</a> <br> <a href="http://www.proxident.se">www.proxident.se</a> <br>  <a href="http://www.sunstargum.se" target="_blank">www.sunstargum.se</a>');
    ...
    else if(language == 'eng')
    {
        ...
        $('.lang_blasor').html('Tips for blisters and sores');
        $('.lang_blasor_short').html('Blisters');
        ...
        $('.lang_tandborstning_text28').html('Toothpaste without taste. Salutem children\'s toothpaste is used for children under the age of 6. For children over the age of 6, Salutem adult and Proxident toothpaste for dry and sensitive mouth is used.');
        $('.lang_tandborstning_text29').html('Profylaxpasta CCS RDA 40');
        ...
        $('.lang_tandborstning_text31').html('Fluoride solution 0.05 % NaF for children aged 6 – 12, and fluoride solution 0.2 % NaF for children over the age of 12 and for adults. Used when increased preventative oral care is required.');
        ...
        $('.lang_tandborstning_text34').html('Information about oral care products and aids can be found on the following websites: <br> <a href="http://www.mun-h-center.se">www.mun-h-center.se</a> <br>    <a href="http://www.apotea.se" target="_blank">www.apotea.se</a> <br> <a href="http://www.proxident.se">www.proxident.se</a> <br>  <a href="http://www.sunstargum.se" target="_blank">www.sunstargum.se</a>');
        ...
        $('.lang_muntorrhet_text2').html('Dry lips and mouth can be caused by mouth breathing and certain medicines. Dry mouth leads to an increased caries risk and may affect the oral mucosa');
        ...
        $('.lang_muntorrhet_text12').html('Further information about oral care products and aids can be found on the following websites: <br> <a href="http://www.mun-h-center.se">www.mun-h-center.se</a> <br>    <a href="http://www.apotea.se" target="_blank">www.apotea.se</a> <br> <a href="http://www.proxident.se">www.proxident.se</a> <br> <a href="http://www.sunstargum.se">www.sunstargum.se</a>');
        ...
        $('.lang_blasor_text1').html('Oral care for children – Tips for blisters (aphthous stomatitis) and sores');
        $('.lang_blasor_text2').html('Blister and sores in the oral mucous membrane and on the tongue can cause pain and difficulties eating, speaking and looking after oral hygiene. If you experience severe discomfort, please contact dental care.');
        $('.lang_blasor_text3').html('SUGGESTED PRODUCTS THAT CAN ALLEVIATE PAIN AND FACILITATE HEALING');
        $('.lang_blasor_text4').html('Zendium toothpaste (adult, junior). Recommended for continuous use if problems are recurring.');
        $('.lang_blasor_text5').html('Sinaftin toothpaste. Recommended for continuous use if problems are recurring.');
        $('.lang_blasor_text6').html('Aftaclear rinse/gel/spray. Gives immediate and long-lasting relief.');
        $('.lang_blasor_text7').html('Further information about oral care products and aids can be found on the following websites: <br> <a href="http://www.mun-h-center.se">www.mun-h-center.se</a> <br>    <a href="http://www.apotea.se" target="_blank">www.apotea.se</a> <br> <a href="http://www.proxident.se">www.proxident.se</a> <br>  <a href="http://www.sunstargum.se" target="_blank">www.sunstargum.se</a>');
